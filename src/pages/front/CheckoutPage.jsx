        ...
        <div className="row">
          ...
          <div className="col-lg-3">
            <div className="border">
              <p className="fs-6 border-bottom p-3">Summary <span>({basketQty} {basketQty === 1 ? 'item' : 'items'})</span></p>
              <ul className="list-unstyled border-bottom px-3 mb-0">
                {cart?.carts?.map((cartItem, index) => (
                  <li key={cartItem.id} className={`d-flex ${index === cart.carts.length - 1 ? '' : 'border-bottom'} py-3 gap-3`}>
                    <div className="w-25">
                      <img
